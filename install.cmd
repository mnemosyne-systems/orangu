...
set "TMP=%TEMP%\orangu-install-%RANDOM%"
...
powershell -NoProfile -NonInteractive -Command ^
    "Expand-Archive -Path '!TMP!\!ASSET!' -DestinationPath '!TMP!\out' -Force"
if not exist "!TMP!\out\orangu.exe" (echo error: binary not found in archive & exit /b 1)
