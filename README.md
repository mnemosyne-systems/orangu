...
- **The whole Git loop lives in the prompt** — branch, commit, rebase, squash, cherry-pick, revert, stash, bisect, push, and GitHub/GitLab pull requests, comments, and issues, all without leaving the terminal.
