...
check "x86_64-unknown-linux-gnu"   "x86_64-unknown-linux-gnu"   "linux gnu triple"
check "aarch64-unknown-linux-musl" "aarch64-unknown-linux-musl" "linux musl triple"
check "aarch64-apple-darwin"       "aarch64-apple-darwin"       "darwin triple"
