...
fn fused_post_attention_matches_cpu_reference_with_ple() {
    ...
    let got = vulkan.fused_post_attention(FusedPostAttentionInput {
        ...
        ffn_norm: &ffn_norm,
        ffn_gate: Some(&ffn_gate),
        ffn_up: Some(&ffn_up),
        ffn_gate_up: None,
        ffn_down: Some(&ffn_down),
...
fn fused_layer_kv_donor_matches_cpu_reference_many_steps() {
    ...
    for step in 0..60 {
        ...
        let got0 = vulkan.fused_layer(FusedLayerInput {
            ...
            ffn_gate: Some(&l0.ffn_gate),
            ffn_up: Some(&l0.ffn_up),
            ffn_gate_up: None,
            ffn_down: Some(&l0.ffn_down),
        ...
        let got1 = vulkan.fused_layer(FusedLayerInput {
            ...
            ffn_gate: Some(&l1.ffn_gate),
            ffn_up: Some(&l1.ffn_up),
            ffn_gate_up: None,
            ffn_down: Some(&l1.ffn_down),
